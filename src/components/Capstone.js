...
export const Capstone = () => {
  ...
  let handleSubmit = async (e, i) => {
    ...
    try {
      let res = await axios.post(`${url}/capsub/submit`, payload);
  ...
  let getData = async () => {
    try {
      let res = await axios.get(`${url}/capstone/get/${name}`, {});
      // toast.success(res.data.message);
      setData(res.data.capstone);
    } catch (error) {
      {
        // toast.error(error.response.data.message);
      }
  ...
  let getCode = async () => {
    try {
      let res = await axios.get(
        `${url}/capsub/get/${name}/${selectedTask}`,
        {}
      );
      // toast.success(res.data.message);
      setCode(res.data.capsub);
    } catch (error) {
      {
        // toast.error(error.response.data.message);
      }
